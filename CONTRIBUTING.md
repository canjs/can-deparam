...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-deparam, you can start by going to its [fork page](https://github.com/canjs/can-deparam/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-deparam
```
